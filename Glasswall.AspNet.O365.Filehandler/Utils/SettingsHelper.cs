...
namespace Glasswall.AspNet.O365.Filehandler
{
    public class SettingsHelper
    {
        ...
        private static string _gwRebuildApi = ConfigurationManager.AppSettings["GwRebuildApi"];
        private static string _gwRebuildApiKey = ConfigurationManager.AppSettings["GwRebuildApiKey"];
        ...
        public static string GwRebuildApi
        {
            get
            {
                return _gwRebuildApi;
            }
        }

        public static string GwRebuildApiKey
        {
            get
            {
                return _gwRebuildApiKey;
            }
        }
    }
}